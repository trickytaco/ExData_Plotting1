#R script to read in household power consumption data and plot a histogram
#of global active power in kilowatts versus frequency. 
...
#Plot the histogram and add appropriate labels and title
